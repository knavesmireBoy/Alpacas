...
gAlp.Presenter = (function(core, conf, tagBuilder, gallery, slideshow) {
     ...
     var EventCache = function() {
        ...
        presentér = {
            ...
            init: function() {
                ...
                this.setView();
                this.children = gAlp.Iterator(null, {loop: false, rev:true});
            ...
            addView: function() {
                ...
                function getOp(){
                     if(this.getChild(2)){
                    var tgt = window.getComputedStyle(this.getChild(1).getElement(), null);
                         return tgt.getPropertyValue('opacity') > .5;
                   }
                }
                
                var undo = this.playbutton2.undo.bind(this.playbutton2), el;
            ...
            bindEvents: function() {
                ...
                if (!this.flag) {
                    addEvent(this.handler, 'click', handler);                    
                        while(L--){
                            addEvent(el[L], 'mouseover', listenUp);
                            addEvent(el[L], 'mouseout', listenDown);
                        }
    ...
    core.augment(presentér, core.create(core.createComponent({}))); 
    core.augment(presentér, core.create(gAlp.Element));
