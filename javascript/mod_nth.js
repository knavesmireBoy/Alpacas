/*!
 * modernizr v3.5.0
 * Build https://modernizr.com/download?-bgrepeatspace_bgrepeatround-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
  ...
  Modernizr.addTest('bgrepeatspace', testAllProps('backgroundRepeat', 'space'));
     Modernizr.addTest('backgroundcolor', function(){
         var cb = function(elem){
             var val = computedStyle(elem, null, 'background-color');
                      alert(val+'!');

             if(!val){
                 return typeof elem.style.backgroundColor !== 'undefined';
             }
             else {
                 return val === 'red';
             }
         };
         val = testStyles("#modernizr {background-color: red;}", cb);
         return val;
     });
