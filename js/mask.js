...
(function (doc, mask_target, swapper, states, mq, query, cssmask, cssanimations, touchevents, report) {
	...
	var utils = gAlp.Util,
		...
		intro2 = " This responsive version has been a great playground for exploring newer css techniques, and most recently sass. The 'For Sale' page is definitely a contender for utilising a database, if only for the R in CRUD, at the moment JS delivers a random number of creatures onload. Such fun.",
