...
(function (doc, mask_target, swapper, states, mq, query, cssmask, cssanimations, touchevents, report) {
	...
	var utils = gAlp.Util,
		...
		intro = "Having worked together on a number of print projects I was approached by Sylvia Sharpe of the <a href= 'https://yorkminster.org/get-involved/donate/york-minster-fund/' target='_blank'>York Minster Fund</a> to work on a website that would support her post-retirement venture, breeding and rearing Alpacas. For this site learning javascript was a requirement as navigating a picture gallery was firmly on the wish list. Jeremy Keith's recently published <a href='https://domscripting.com/book/' target='_blank'>Dom Scripting</a> was simply the right book at the right time. It was a bible of best practice and remains a great introduction for crafting bespoke websites. Carlos & co were to find new homes so the original site is sadly no longer hosted at www.granaryalpacas.co.uk, but it would have looked like this the last time I worked on it in <a href='https://knavesmireboy.github.io/legacy_alpacas/' target='_blank'>2011</a>.",
		intro2 = " This responsive version has been a great playground for exploring newer css techniques, and most recently sass. The 'For Sale' page is definitely a contender for utilising a database, if only for the R in CRUD, at the moment JS delivers a random number of creatures onload, otherwise, with the execption of that gallery, JS is only used to provide a fallback for older browsers that don't support modern features like css-mask, which has always been mission critical for this particular site.",
